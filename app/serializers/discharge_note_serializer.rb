class DischargeNoteSerializer < ActiveModel::Serializer
  ...
  :procedures_performed, :hospital_course, :discharge_medications, :discharge_instructions, :follow_up, :created_at, 
  :updated_at, :patient_id, :patient_header, :provider_header
